...
const ReplyModal = (props) => {
    const { commentId, handleCommentId, showReport, setShowReport, comment, user, post, handleFetchChildComments, handleFetchComments } = props
    ...
    const submitComment = async () => {
        ...
        try {
            ...
            formData.append('report_comment', data.comment_text)
