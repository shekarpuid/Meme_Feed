...
function ChangeHandleName(props) {
    ...
    const handleSubmit = async () => {
        if (value.length === 0) {
            ...
            try {
                ...
                formData.append('handle_name', value)
                ...
                alert("Successfully changed handle name.")
                setValue('')
        ...
        <>
            <Container style={styles.blueBg}>
                <Content style={styles.content}>
                    <H1 style={styles.h1}>Change Handle Name</H1>
                    <Item regular>
                        <TextInput light placeholder="Handle name*" value={value} onChangeText={(value) => setValue(value)} />
                    </Item>
...
export default connect(mapStateToProps, mapDispatchToProps)(ChangeHandleName)